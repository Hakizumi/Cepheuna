 ...
 * <p>
 * Tool event streaming wrappers are intentionally removed in this version
 ...
 * <p>
 * Adapted 1.3.0-beta's changements.
 *
 * @since 1.2.0-beta
 * @version 1.1.0
 * @author Sempiria
...
@Service
@Slf4j
public class OpenaiOnlineLLMServiceImpl implements BasicLLMService {
    private final ChatClient chatClient;
    private final ConversationStore conversationStore;

    public OpenaiOnlineLLMServiceImpl(@Qualifier("decisionClient") ChatClient chatClient, ConversationStore conversationStore) {
    ...
    public @NonNull ChatResponse reach(@NonNull ChatRequest req) {
        ...
        ChatClientRequestSpec spec = chatClient.prompt()
                ...
                .user(Objects.requireNonNull(req.userInput()));
